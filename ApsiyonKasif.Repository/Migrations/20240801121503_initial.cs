    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BuildingComplexes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuildingComplexId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Apartments_HeatingTypes_HeatingTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GrossArea = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NetArea = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    BathromCount = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Homes_RoomCount_RoomCountId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_Adverts_AdvertId",
                        column: x => x.AdvertId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Apartments_BuildingComplexId",
                table: "Apartments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Apartments_HeatingTypeId",
                table: "Apartments",
                column: "HeatingTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Appointments_AdvertId",
                table: "Appointments",
                column: "AdvertId");
